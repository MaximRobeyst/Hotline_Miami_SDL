...
namespace utils
{
	...
	const float g_Deg2Rad{ g_Pi / 180.0f };
	const float g_Rad2Deg{ 180.0f / g_Pi };
...
#pragma region CollisionFunctionality
	...
	float GetSquaredDistance(const Point2f& a, const Point2f& b);
	float GetSquaredDistance(const Vector2f& a, const Vector2f& b);
