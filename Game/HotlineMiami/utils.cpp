...
float utils::GetDistance(const Point2f& a, const Point2f& b)
{
	return sqrtf(powf(b.x - a.x, 2) + powf(b.y - a.y, 2));
}

float utils::GetDistance(const Vector2f& a, const Vector2f& b)
{
	return sqrtf(powf(b.x - a.x, 2) + powf(b.y - a.y, 2));
}

float utils::GetSquaredDistance(const Point2f& a, const Point2f& b)
{
	return sqrtf(powf(b.x - a.x, 2) + powf(b.y - a.y, 2));
}

float utils::GetSquaredDistance(const Vector2f& a, const Vector2f& b)
{
